...
public class AreaCreator extends Script implements Painting, EventBlockingOverride {

	private static final String PREFIX = "private final RSArea area = ";
	private final ArrayList<RSTile> tileList = new ArrayList<>();
	...
	private void onTileListChanged() {
		...
		area = new RSArea(tiles); // copy to clipboard
